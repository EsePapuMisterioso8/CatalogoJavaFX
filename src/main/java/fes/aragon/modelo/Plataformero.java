    ...
    public Plataformero(int x, int y, String imagen, int velocidad) {
        ...
        for(int i=0;i<=38;i++){
            ...
            switch (i){
                ...
                case 9:
                    plataforma = new Rectangle(901,573,50,5);
                    plataformas.add(plataforma);
                    break;
                ...
                case 14:
                    plataforma = new Rectangle(364,565,254,10);
                    plataformas.add(plataforma);
                    break;

                case 15:
                    plataforma = new Rectangle(444,537,35,5);
                    plataformas.add(plataforma);
                    break;
                ...
                case 18:
                    plataforma = new Rectangle(233,501,31,5);
                    plataformas.add(plataforma);
                    break;
                ...
                case 21:
                    plataforma = new Rectangle(1,432,35,5);
                    plataformas.add(plataforma);
                    break;

                case 22:
                    plataforma = new Rectangle(70,409,33,5);
                    plataformas.add(plataforma);
                    break;
